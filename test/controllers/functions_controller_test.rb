...
class FunctionsControllerTest < ActionController::TestCase
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post :create, function: { father_id: @function.father_id, info: @function.info, name: @function.name, rol_id: @function.rol_id, url: @function.url }
    end
  ...
  test "should update function" do
    patch :update, id: @function, function: { father_id: @function.father_id, info: @function.info, name: @function.name, rol_id: @function.rol_id, url: @function.url }
    assert_redirected_to function_path(assigns(:function))
  end
